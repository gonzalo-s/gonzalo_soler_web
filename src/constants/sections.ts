...
//       text: 'I thrive in fast-paced teams where I can take ownership, collaborate closely with product and design, and move with autonomy. Always learning, always iterating—I’m passionate about building thoughtful, future-ready solutions that work beautifully across browsers and devices. \n \n Before moving into tech, I ran my own recording studio for eight years, where I handled everything from sound engineering and production to client management, scheduling, and marketing. That experience taught me how to juggle multiple responsibilities, communicate effectively with diverse teams, and deliver high-quality work under tight deadlines. \n \n My curiosity for the Tech side of audio gear to digital systems—naturally evolved into a passion for web development. In my current role, I focus on building user-friendly, responsive interfaces that balance performance with great user experience. I thrive in collaborative environments and enjoy thinking beyond the UI, considering how frontend decisions align with broader product goals. \n \n Looking ahead, I’d like to grow into a tech lead position, and eventually an architect role, where I can contribute to technical vision and shape scalable solutions across projects.',
//     },
//   },
//   {
//     type: 'Technologies',
